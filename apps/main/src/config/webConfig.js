...
export const CONFIG = {
  ...
  app: {
    name: "locket-onl", // Tên app hiển thị
    author: "vu thien nhan",
    shortname: "locket-onl",
    fullName: "locket-onl - Đăng ảnh & Video lên Locket", // Tên đầy đủ
    clientVersion: "Beta1.0.1.6", // Version client
    ...
    videoTutorials: {
      ...
      iosAddscreen: {
        title: "Hướng dẫn thêm locket-onl vào màn hình chính trên iPhone!",
        url: "https://www.youtube.com/embed/iElPAnQ7lNY",
      }, // Hướng dẫn thêm trang web vào màn hình chính trên iPhone (Safari)
      androidAddscreen: {
        title: "Hướng dẫn thêm locket-onl vào màn hình chính trên Android!",
